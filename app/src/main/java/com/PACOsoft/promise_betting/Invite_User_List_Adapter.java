...
public class Invite_User_List_Adapter extends RecyclerView.Adapter<Invite_User_List_Adapter.CustomViewHolder> {

    private ArrayList<User> arrayList;
    private Context context;

    public Invite_User_List_Adapter(ArrayList<User> arrayList, Context context) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.invite_user_list_item, parent, false);
